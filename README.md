...
the code runs on a **Flask** backend with **vanilla HTML, CSS, and JavaScript** on the front. no frameworks.
...
[doyouevengif-alt](https://github.com/Haymawon/DoYouEvenGif-alt?utm_source=Lain)
